report 50114 "Letter Of Demand Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './sourceCode/reportLayout/Layout_50114_LetterOfDemand_Summary.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            DataItemTableView = WHERE("Document Type" = filter(Invoice), "Levy Invoice" = filter(true));
            ...
            begin
                ...
                VarHeadInfo[2] := "No.";
                VarHeadInfo[3] := Format("Due Date", 0, '<Day,2> <Month Text> <Year4>');
