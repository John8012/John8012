report 50101 "Sales Order Levy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './sourceCode/reportLayout/Layout_50101_salesOrderLevy.rdl';
    PreviewMode = PrintLayout;
    Caption = 'Sales Order Levy';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        begin
                            ...
                            if ("Line Amount" >= 0) and ("Line Amount" <= 2000000) then
                                VarLinesValDec[2] := 1;
                            if ("Line Amount" >= 2000001) and ("Line Amount" <= 5000000) then
                                VarLinesValDec[2] := 0.8;
                            if ("Line Amount" >= 2000001) and ("Line Amount" <= 5000000) then
                                VarLinesValDec[2] := 0.8;
                            if ("Line Amount" >= 5000001) and ("Line Amount" <= 10000000) then
                                VarLinesValDec[2] := 0.75;
                            if ("Line Amount" >= 10000001) and ("Line Amount" <= 15000000) then
                                VarLinesValDec[2] := 0.6;
                            if ("Line Amount" >= 15000001) then
                                VarLinesValDec[2] := 0.5;
                            //VarLinesValDec[2] := RecProject."Levy %";
                            VarLinesValDec[3] := ("Line Amount" * VarLinesValDec[2]) / 100;
                            // end;
                            //end;
                        end;
                    }
            ...
            begin
                ...
                RecSlsLine.Reset;
                RecSlsLine.SetRange("Document Type", "Document Type");
                ...
                //         VarBillTo[4] := "Bill-to City" + ', ' + RecCountry.Name + ' ' + "Bill-to Post Code";
                // end else begin
                //     RecCountry.Reset;
                //     if RecCountry.Get("Bill-to Country/Region Code") then
                ...
                // VarBillTo[6] := 'Email ' + RecCust."E-Mail";
                // VarBillTo[7] := 'Phone ' + RecCust."Phone No.";
                // end;
