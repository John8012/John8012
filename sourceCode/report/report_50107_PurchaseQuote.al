report 50107 "CIC PurchaseQuote"
{
    DefaultLayout = RDLC;
    RDLCLayout = './sourceCode/reportLayout/Layout_50107_PurchaseQuote.rdl';
    Caption = 'CIC Purchase Quote';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PurchaseQuoteCopyText; Text003)
                    {
                    }
            ...
            begin
                ...
                varReqDetail := getRequitionDetails;
            end;
    ...
    var
        ...
        varReqDetail: Text;
        Text003: label 'Purchase To Request';
