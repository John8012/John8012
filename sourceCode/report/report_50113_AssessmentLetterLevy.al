report 50113 "Assessment Letter Levy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './sourceCode/reportLayout/Layout_50113_AssessmentLetterLevy.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        begin
                            ...
                            // VarLinesValDec[3] := "Line Amount" + "Line Discount Amount";
                            // VarLinesValDec[4] := 0;
                            //end;
                        end;
                    }
            ...
            begin
                ...
                VarHeadInfo[2] := "No.";
                VarHeadInfo[3] := "External Document No.";
                ...
                if RecCust.get("Bill-to Customer No.") then begin
                    ...
                    VarHeadInfo[3] := RecProject."Project Number";
                end;
                ...
                if "Bill-to City" <> '' then begin
                    ...
                    RecCountry.Reset;
                    if RecCountry.Get("Bill-to Country/Region Code") then
                        VarBillTo[4] := RecCountry.Name + ' ' + "Bill-to Post Code";
                end;

                if RecContact.Get("Bill-to Contact No.") then begin
                    VarBillTo[5] := 'Tel: ' + RecContact."Phone No.";
                end;

                //Bill to
                VarShipTo[1] := RecProject."POC Contact Name";
                VarShipTo[2] := RecProject."POC Contact Surname";
                VarShipTo[3] := RecProject.getPostalAddress();

                if RecProject."POC Phone No." <> '' then
                    VarShipTo[4] := 'Tel: ' + RecProject."POC Phone No.";


                VarFootValDec[1] := RecProject."Levy %";
                VarFootValDec[2] := RecProject."Levy Amount";
                VarFootValDec[3] := RecProject."Contract Sum";
