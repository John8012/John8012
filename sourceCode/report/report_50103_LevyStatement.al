report 50103 "Levy Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './sourceCode/reportLayout/Layout_50103_LevyStatement.rdl';
    ApplicationArea = All;
    Caption = 'Levy Statement';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(No2_Cust; Customer."No.")
                {
                }
                column(No1_Cust; Customer."No.")
                {
                }
                column(CustName; varCustomerName)
                {
                }
                ...
                column(TotalRemainingAmt; TotalRemainingAmt)
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            var
                                ...
                                RecSaleInvHdr: Record "Sales Invoice Header";
                            begin
                                SalespersonCode := '';
                                ...
                                case "Entry Type" of
                                    "Entry Type"::"Initial Entry":
                                        begin
                                            ...
                                            RecSaleInvHdr.Reset();
                                            RecSaleInvHdr.SetRange("No.", CustLedgerEntry."Document No.");
                                            RecSaleInvHdr.SetRange("Levy Invoice", true);
                                            if not RecSaleInvHdr.FindSet() then
                                                CurrReport.Skip();
                                            ...
                                            TotalRemainingAmt += RemainingAmount;
                                            RecProject.Reset();
                                            RecProject.SetRange("Customer No.", Customer."No.");
                                            RecProject.SetRange("Posted Invoice No.", CustLedgerEntry."Document No.");
                                            if RecProject.FindFirst() then;
                                            if RecProject."Levy payment option" = 'PAID by Contractor' then
                                                varCustomerName := RecProject."POC Contact Name"
                                            else
                                                varCustomerName := Customer.Name;
                                            Payment := RecProject."Levy Paid";
                                            SalespersonCode := RecProject."Project Details";
                                            ExtDocNo := RecProject."POC Contact Name";
                                        end;
                                    ...
                                    if DtldCustLedgEntries."Document Type" = DtldCustLedgEntries."Document Type"::Payment then
                                        ...
                                        if DtldCustLedgEntries."Document Type" = DtldCustLedgEntries."Document Type"::Invoice then begin
                                            ...
                                            if SalesInvoiceHeader.FindFirst then begin
                                                RecProject.Reset();
                                                RecProject.SetRange("Customer No.", SalesInvoiceHeader."Bill-to Customer No.");
                                                RecProject.SetRange("Invoice No.", SalesInvoiceHeader."No.");
                                                if RecProject.FindFirst() then
                                                    SalespersonCode := RecProject."Project Details";
                                                ExtDocNo := RecProject."POC Contact Name";
                                            ...
                                            if DtldCustLedgEntries."Document Type" = DtldCustLedgEntries."Document Type"::"Credit Memo" then begin
                                                ...
                                                if SalesCreditMemo.FindFirst then begin
                                                    RecProject.Reset();
                                                    RecProject.SetRange("Customer No.", SalesCreditMemo."Bill-to Customer No.");
                                                    RecProject.SetRange("Invoice No.", SalesCreditMemo."No.");
                                                    if RecProject.FindFirst() then
                                                        SalespersonCode := RecProject."Project Details";
                                ...
                                //  ExtDocNo := CustLedgerEntry."External Document No.";
                                // end;
                            end;
            ...
            begin
                ...
                if RecProject.FindFirst() then begin
                    if RecProject."Levy payment option" = 'PAID by Contractor' then
                        CustCountry := RecProject.getPostalAddress();
                end;
