report 50106 "Letter Of Demand"
{
    DefaultLayout = RDLC;
    RDLCLayout = './sourceCode/reportLayout/Layout_50106_LetterOfDemand.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                VarDocTittle := 'LEVY ASSESSMENT LETTER';
                ...
                VarHeadInfo[2] := "No.";
                VarHeadInfo[3] := Format(CalcDate('+6D', Today), 0, '<Day,2> <Month Text> <Year4>');

                VarHeadInfo[4] := Format(Today, 0, '<Day,2> <Month Text> <Year4>');

                RecProject.Reset();
                RecProject.SetRange("Customer No.", "Bill-to Customer No.");
                RecProject.SetRange("Posted Invoice No.", "No.");
                if RecProject.FindSet() then
                    VarHeadInfo[5] := RecProject."Project Details";
                ...
                if RecProject."Levy payment option" = 'PAID by Contractor' then begin
                    ...
                    VarBillTo[2] := RecProject.getPostalAddress();
                end else begin
                    VarBillTo[1] := RecCust.Name;
                    VarBillTo[2] := RecCust.Address;
                    VarBillTo[3] := RecCust."Mobile Phone No.";
                    VarBillTo[4] := RecCust."E-Mail";
                end;
                ...
                //  VarBillTo[7] := 'Tel: ' + RecProject."POC Phone No.";
                //end;
                ...
                //VarFootValDec[7] := "Remaining Amount";
                RecProject.Reset();
                RecProject.SetRange("Customer No.", "Bill-to Customer No.");
                RecProject.SetRange("Posted Invoice No.", "No.");
                if RecProject.FindSet() then begin
                    VarAddInfo[1] := RecProject."POC Contact Name";
                    VarAddInfo[2] := RecProject."Project Details";
                    VarFootValDec[6] := RecProject."Levy Paid";
                    VarFootValDec[7] := RecProject."Levy Balance";
                end;
                // RecCust.Reset();
                // if RecCust.get("Bill-to Customer No.") then begin
                //     VarAddInfo[1] := RecCust."POC Contact Name";
                //     VarAddInfo[2] := RecCust."Project Details";
                //     VarFootValDec[6] := RecCust."Levy Paid";
                //     VarFootValDec[7] := RecCust."Levy Balance";
                // end;
